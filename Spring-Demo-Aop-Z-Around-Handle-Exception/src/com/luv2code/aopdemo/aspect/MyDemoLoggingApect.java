...
public class MyDemoLoggingApect {
	...
	public Object aroundGetFortune(ProceedingJoinPoint theProceedingJoinPoint) throws Throwable {
		...
		try {
			...
			// THIS IS TO CATCH THE EXCEPTION, LOGG IT AND RE-THROW IT
			myLogger.warning("Found an exception on " + method + ", here is the message: " + e.getMessage());
			// Re-throw exception
			throw e;

			/*
			 * THIS WAS TO CATCH THE EXCEPTION, PROCESS IT AND CREATE A NEW RESULT // Log
			 * the exception myLogger.warning(e.getMessage()); // Give the user a customer
			 * message result =
